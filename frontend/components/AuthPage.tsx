            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-[#0d1117] border border-[#30363d] rounded-xl px-4 py-3 pr-12 text-white focus:outline-none focus:border-[#39d353] transition-colors"
                  placeholder="••••••••"
                  required
                  minLength={6}
                />
                <button
                  ...
                  className="absolute right-4 top-1/2 -translate-y-1/2 text-[#8b949e] hover:text-[#39d353] transition-colors text-sm font-bold"
                >
